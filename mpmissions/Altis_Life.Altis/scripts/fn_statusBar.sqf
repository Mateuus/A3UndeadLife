...
[] spawn {
	...
	while {true} do
	{
		...
		_counter = _counter - 1;
		((uiNamespace getVariable "osefStatusBar")displayCtrl 1000)ctrlSetStructuredText parseText format["|| <t color='#4752e0'>Policiais:</t> <t color='#ffffff'>%1</t> | <t color='#bf7e00'>Civis:</t> <t color='#ffffff'>%2</t> | <t color='#00DD00'>Medicos:</t> <t color='#ffffff'>%3</t> | <t color='#fbf896'>FPS:</t> <t color='#ffffff'>%4</t>||", west countSide playableUnits, civilian countSide playableUnits, independent countSide playableUnits, round diag_fps];
	};
};